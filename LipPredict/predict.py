from lipreading.lipper.videos import Video
from lipreading.lipper.visualization import show_video_subtitle
from lipreading.lipper.helpers import labels_to_text
from lipreading.core.decoders import Decoder
from lipreading.utils.spell import Spell
from lipreading.model import LipNet
...
FACE_PREDICTOR_PATH = 'common/shape_predictor_68_face_landmarks.dat'
...
def process_video(input_video_path):
    ...
    for i in np.arange(num_frames):
      ...
      # print("writing frame {counter + 1} with activation {activation[counter]}")
